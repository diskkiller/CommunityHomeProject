...
public class BaseCallActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (isGroupCall(mGroupID, mUserIds, mRole, mIsFromGroup)) {
            ...
            if (TUICalling.Type.AUDIO == mType) {
                ...
                mVideoFactory = new VideoLayoutFactory(getApplicationContext());
            ...
            imageBack.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    if (!PermissionUtil.hasPermission(getApplicationContext())) {
                        Toast.makeText(getApplicationContext(),getString(R.string.trtccalling_float_permission),Toast.LENGTH_LONG).show();
                        return;
                    }
                    ...
                    Display d = ((WindowManager) m).getDefaultDisplay();
                    WindowManager.LayoutParams p = getWindow().getAttributes();
                    p.height = (int) (d.getHeight() * 0.1);
                    p.width = (int) (d.getWidth() * 0.1);
                    p.dimAmount = 0.0f;
    ...
    private BaseTUICallView createVideoView(TUICalling.Role role, TUICalling.Type type, String[] userIds,
                                            String sponsorID, String groupID, boolean isFromGroup) {
        return new TUICallVideoView(getApplicationContext(), role, type, userIds, sponsorID, groupID, isFromGroup, mVideoFactory) {
            @Override
            public void finish() {
                super.finish();
                BaseCallActivity.this.finish();
    ...
    private FloatCallView createFloatView() {
        ...
        return new FloatCallView(getApplicationContext(), mRole, type, mUserIds, mSponsorID, mGroupID, mIsFromGroup, mVideoFactory) {
            @Override
    ...
    private void startFloatService() {
        ...
        if (PermissionUtil.hasPermission(this)) {
            ...
            FloatWindowService.startFloatService(getApplicationContext(), mFloatView);
        } else {
