...
import com.diskkiller.http.body.JsonBody;
import com.diskkiller.http.body.ProgressBody;
import com.diskkiller.http.body.TextBody;
import com.diskkiller.http.body.UpdateBody;
import com.diskkiller.http.listener.OnHttpListener;
import com.diskkiller.http.listener.OnUpdateListener;
import com.diskkiller.http.model.BodyType;
import com.diskkiller.http.model.FileContentResolver;
...
public abstract class BodyRequest<T extends BodyRequest<?>> extends HttpRequest<T> {
    ...
    protected void printRequestLog(Request request, HttpParams params, HttpHeaders headers, BodyType type) {
        ...
        if (body instanceof FormBody ||
            ...
            // 打印表单
            EasyLog.printKeyValue(this, "打印表单  RequestMethod", getRequestMethod());
            ...
            // 打印 Json
            EasyLog.printKeyValue(this, "打印 Json  RequestMethod", getRequestMethod());

            EasyLog.printJson(this, body.toString());
        } else if (body != null) {
            // 打印文本

            EasyLog.printKeyValue(this, "打印文本  RequestMethod", getRequestMethod());
    ...
    private RequestBody createRequestBody(HttpParams params, BodyType type) {
        ...
        if (params.isMultipart() && !params.isEmpty()) {
            ...
            EasyLog.printLog(this, "==========type===="+type);
