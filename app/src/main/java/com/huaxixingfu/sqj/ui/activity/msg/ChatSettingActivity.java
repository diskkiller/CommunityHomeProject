...
public class ChatSettingActivity extends AppActivity {
    ...
    public void onClick(View v) {
        ...
        if (id == R.id.iv_rename) {
            String name = StringUtils.isEmpty(tv_friend_nickname.getText().toString())
                    ?
                    "":tv_friend_nickname.getText().toString();
    ...
    private void setFrindData(FriendDetailBean data) {
        ...
        if(data.userType == 3){
            ...
            iv_rename.setVisibility(View.GONE);
            sb_address.setVisibility(View.GONE);
        }else{
            ll_friend_nickname.setVisibility(View.VISIBLE);
            iv_rename.setVisibility(View.VISIBLE);
            sb_address.setVisibility(View.VISIBLE);
