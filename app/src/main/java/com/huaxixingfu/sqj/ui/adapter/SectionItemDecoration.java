...
public class SectionItemDecoration extends RecyclerView.ItemDecoration {
    ...
    private List<MailListApi.Bean> mData;
    ...
    public SectionItemDecoration(Context context, List<MailListApi.Bean> data) {
        this.mData = data;
    ...
    public void setData(List<MailListApi.Bean> data) {
        this.mData = data;
    }
