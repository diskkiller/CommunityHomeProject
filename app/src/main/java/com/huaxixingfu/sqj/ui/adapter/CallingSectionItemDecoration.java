...
import com.huaxixingfu.sqj.utils.DPutils;

import java.util.List;

public class CallingSectionItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public CallingSectionItemDecoration(Context context, List<GroupMemberBean> data) {
        this.mData = data;
        this.context = context;

        mBgColor = Color.parseColor("#F7F7F7");
        mSectionHeight = DPutils.dp2px(28, context);
        mTextSize = DPutils.dp2sp(14, context);
    ...
    private void drawSection(Canvas c, int left, int right, View child,
        ...
        //如果是#，忽略不画
        if (mData.get(position).getSection().equals("header")){
            return;
        }
