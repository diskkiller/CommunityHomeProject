...
import com.huaxixingfu.sqj.widget.PasswordView;
...
public final class PayPasswordDialog {
    ...
    private static final class KeyboardAdapter extends AppAdapter<String> {
        ...
        public AppAdapter<?>.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            switch (viewType) {
                case TYPE_DELETE:
                    return new SimpleHolder(R.layout.pay_password_delete_item);
                case TYPE_EMPTY:
                    return new SimpleHolder(R.layout.pay_password_empty_item);
                default:
