...
import com.diskkiller.http.config.IRequestHandler;
import com.diskkiller.http.exception.CancelException;
import com.diskkiller.http.exception.DataException;
import com.diskkiller.http.exception.HttpException;
import com.diskkiller.http.exception.NetworkException;
import com.diskkiller.http.exception.NullBodyException;
import com.diskkiller.http.exception.ResponseException;
import com.diskkiller.http.exception.ServerException;
import com.diskkiller.http.exception.TimeoutException;
import com.diskkiller.http.request.HttpRequest;
import com.google.gson.JsonSyntaxException;
import com.hjq.gson.factory.GsonFactory;
import com.huaxixingfu.sqj.R;
import com.huaxixingfu.sqj.http.exception.ResultException;
import com.huaxixingfu.sqj.http.exception.TokenException;
    ...
    public Exception requestFail(@NonNull HttpRequest<?> httpRequest, @NonNull Exception e) {
        if (e instanceof HttpException) {
            if (e instanceof TokenException) {
                // 登录信息失效，跳转到登录页
                ActivityManager.getInstance().loginOut(mApplication);
            }
            return e;
        }
