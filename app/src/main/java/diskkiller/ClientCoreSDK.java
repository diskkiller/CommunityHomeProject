...
import diskkiller.core.AutoReLoginDaemon;
import diskkiller.core.KeepAliveDaemon;
import diskkiller.core.LocalDataReciever;
import diskkiller.core.LocalSocketProvider;
import diskkiller.core.QoS4ReciveDaemon;
import diskkiller.core.QoS4SendDaemon;
import diskkiller.event.ChatBaseEvent;
import diskkiller.event.ChatMessageEvent;
import diskkiller.event.MessageQoSEvent;
...
//		init();
    ...
    public void release() {
        this.setConnectedToServer(false);// Bug FIX:  2021-02-23 add by Jack Jiang
